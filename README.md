...
**GetSub** is a tool written in Python to help you **download subtitles in any language** and **sync automatically** using Voice Activity Detection via [py-webrtcvad](https://github.com/wiseman/py-webrtcvad). 
